...
#include "S733LSyPawnMovementComponent.h"

void US733LSyPawnMovementComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void US733LSyPawnMovementComponent::JumpStart()
{
	VerticalVelocity = InitialJumpVelocity * FVector::UpVector;
}

bool US733LSyPawnMovementComponent::IsFalling() const
{
	return bIsFalling;
}
