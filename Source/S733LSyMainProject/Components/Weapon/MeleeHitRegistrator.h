...
class S733LSYMAINPROJECT_API UMeleeHitRegistrator : public USphereComponent
{
	GENERATED_BODY()
...
private:
	FVector PreviousComponentLocation = FVector::ZeroVector;// Предыдущая локация сферы
};
