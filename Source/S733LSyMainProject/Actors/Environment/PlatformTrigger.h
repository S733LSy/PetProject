...
class APawn;
UCLASS()
class S733LSYMAINPROJECT_API APlatformTrigger : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(ReplicatedUsing=OnRep_IsActivated) // при репликации вызывает коллбэк на КЛИЕНТАХ, когда от сервера придёт сообщение
